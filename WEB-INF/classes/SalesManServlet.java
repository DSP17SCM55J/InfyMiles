...
out.println("  </div>");
out.println(" </nav>");
out.println("<input type=\"button\" id=\"cartbutton\" name=\"cartbutton\" value=\"Create User Account\" onclick=\"window.location.href='RegisterServlet'\" />");
out.println("<input type=\"button\" id=\"cartbutton\" name=\"cartbutton\" value=\"Process Orders\" onclick=\"window.location.href='UpdateOrderServlet'\" />");
		out.println(footer);
		out.close();
    }
