...
public class ProdChicagoRateServlet extends HttpServlet {
...
out.println("	<th> Total Reviews</th>    ");
out.println("  </tr>");		
while (z < cnt){
if(map2.get(z+7).toString().equals("Chicago")){
out.println("  <tr>");
...
out.println("<td><center><font size=\"3\"><p>" + map2.get(z+7) + "</p></font></center></td>");
