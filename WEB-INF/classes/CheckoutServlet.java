...
public class CheckoutServlet extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
		...
		showPage(response, "Welcome   ",request.getParameter("prid"), (String) session.getAttribute("username"), request.getParameter("quantity"));
		else 
		showPage(response, "Welcome  to Smart Portables", request.getParameter("prid"),null,null); 
    }     
	
    protected void showPage(HttpServletResponse response, String message, String prodid , String uname, String qty)
    throws ServletException, java.io.IOException {
...
out.println("<input type=\"text\"required placeholder=\"Zip\"  name=\"Zip\"  pattern=\".{5,}\" title=\"XXXXX - Invalid Zip\" maxlength=\"5\" >");
out.println("</td></tr>");
...
out.println("<input type=\"text\"required  placeholder=\"Creditcard\"  name=\"Card\"  maxlength=\"16\"></td></tr> ");
out.println("<tr><td><input type=\"submit\" id=\"submit\" value=\"Place Order\"></td></tr> ");
