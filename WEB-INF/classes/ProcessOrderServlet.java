...
public class ProcessOrderServlet extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
		...
		showPage(response, "Welcome   ",(String) session.getAttribute("username"), request.getParameter("id"));
		else 
		showPage(response, "Welcome  to Smart Portables", null,null); 
    }     
	
    protected void showPage(HttpServletResponse response, String message, String uname, String prdid)
    throws ServletException, java.io.IOException {
...
out.println(" </nav>");
		...
		while(x < partsmap.length){
			  // System.out.println(partsmap[x]);
			   ...
			   if(partsmap[x].equals("smartwatch") && count == 0){
				   y = x;
			   		count = 5;
			   		}
			   x++;
