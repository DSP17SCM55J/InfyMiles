...
out.println(" </nav>");
		...
		while(x < partsmap.length){
			...
			while(itr < partsmap.length && cnt<5){
			   ...
			   out.println("<a href=\"ProdDetailServlet?id=" + pid + "\" ><div class=\"floated_img\"><img src=\"template/images/" +value + "\" " + "width=\"100\" " + "height = \"60\"" + "style=\"margin-left:50px;margin-top:50px\"  /></a>");
			   out.println("<center><p style=\"margin-left:50px;margin-top:50px\">" + pname + "</p><p style=\"margin-left:50px\"> Price: " + pprice + "</p></center></div>");
			   itr = itr+10;
			   cnt++;
			}
			cnt = 0;
			out.println("<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><h3> Top 5 Most sold Products </h3>");
			while(itr < partsmap.length && cnt<5){
			   value = (String)map.get(itr+64);
			   String pid = (String)map.get(itr+61);
			   String pname = (String)map.get(itr+63);
			   String pprice = (String)map.get(itr+65);
			   out.println("<a href=\"ProdDetailServlet?id=" + pid + "\" ><div class=\"floated_img\"><img src=\"template/images/" +value + "\" " + "width=\"100\" " + "height = \"60\"" + "style=\"margin-left:50px;margin-top:50px\"  /></a>");
			   out.println("<center><p style=\"margin-left:50px;margin-top:50px\">" + pname + "</p><p style=\"margin-left:50px\"> Price: " + pprice + "</p></center></div>");
			   itr = itr+10;
			   cnt++;
			}
			out.println("<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><h3> Top 5 Zip Code where Most Products are sold </h3>");
			out.println("<h4>60616 - Chicago</h4>");
			out.println("<h4>60636 - Oak Park</h4>");
			out.println("<h4>61655 - Schaumburg</h4>");
			out.println("<h4>68863 - Rosemont</h4>");
			out.println("<h4>65545 - Aurora</h4>");
